...
def main(datadir):
    ...
    savepath =datadir +"/results"
    os.mkdir(savepath)
    rep_error = output(images,i_points,r_points, res, savepath)
...
#Main
def plane_raw_chess_main(datadir, size):
    ...
    #Use Checkerboard properties to find points
    objpoints,imgpoints = p.checker_img_points(images, p.obj_points(size,10), size)
    #Determine initial parameters p0 by fitting linearly
    p_ext = []
    for i in range(len(objpoints)):
        fit = ff.initial_guess(objpoints[i],imgpoints[i])
    ...
    #p0= [500,500,675,320,0,0,0,0] + p_ext
    #p0: left
    #p0= [600,600,675,500,0,0,0,0] + p_ext
    #p0: front high
    #p0 = [600,600,0,320,0,0,0,0] + p_ext
    #p0: left middle
    p0 = [800, 800, 300, 300, 0, 0, 0, 0] + p_ext
    ...
    #Create plots and output json
    savedir= datadir+"/result/"
#    os.mkdir(savedir)

    rep_error = output(images,i_points,r_points, res, savedir)
    print(rep_error)
...
pattern_size = (17,12)
right_high_datadir="D:/icecube/chessboard/200922_right_high"
right_middle_datadir="D:/icecube/chessboard/200922_right_middle/dis-image"
front_datadir="D:/icecube/chessboard/200910_front-20200915T051249Z-001/200910_front"
left_datadir="D:/icecube/chessboard/200910_left-20200915T051404Z-001/200910_left"
left_middle_datadir="D:/icecube/chessboard/200922_left_middle/dis-image"
right_datadir="D:/icecube/chessboard/200910_right-20200915T051433Z-001/200910_right"
front_high_datadir="D:/icecube/chessboard/200910_front_high-20200915T051327Z-001/200910_front_high"
#left_middle_datadir="D:/icecube/chessboard/200922_left_middle/dis-image"
left_high_datadir="D:/icecube/chessboard/200922_left_high/dis-image"

plane_raw_chess_main(datadir=left_middle_datadir, size=pattern_size)
